...
/* This string printing and boilerplate constructors should live in ir-types.h
 * its just mechanical and cluttering up the file */
...
/* ^^^^ Above this to go to ir-types.{h, c} */
