...
void _astToString(AoStr *str, Ast *ast, int depth) {
    ...
    case AST_ASM_FUNCALL: {
        ...
        case AST_CLASS_REF: {
            ...
            while (--field_idx != -1) {
                aoStrCatFmt(class_path, "%s%s", ref_notation[field_idx], fields[field_idx]);
            }
