...
"syn keyword cType     u0 bool i8 u8 i16 u16 i32 u32 i64 u64 f64 str
...
"syntax region _AsmBlock start="\<asm\s*{\>" end="\<}\>" contains=cAsmLabel,cAsmFunction,cAsmOp
"syntax match cAsmLabel "@@\d\+" contained
"
"
"syntax keyword cAsmOp MOVQ contained
"hi def link cAsmOp cConstant
"
...
"hi cAsmLabel ctermfg=magenta guifg=magenta

"syntax match cFunctionPointer "\(.*\) (\*\w\+)(.*)" contained
"hi def link cCustomFunctionPtr Type
